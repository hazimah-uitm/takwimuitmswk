...
<body>
    <div class="container-fluid px-2 px-md-3 py-2 mt-3">
        <div id="publicCalendar"></div>
        <small class="text-muted fst-italic">*Sila klik program untuk maklumat lanjut. Tarikh dan masa program tertakluk
            pada pindaan.</small>
    </div>
