            ...
            <form method="POST" action="{{ $save_route }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('nama_program') ? 'is-invalid' : '' }}"
                        id="nama_program" name="nama_program" value="{{ old('nama_program') }}" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control {{ $errors->has('penganjur') ? 'is-invalid' : '' }}"
                            id="penganjur" name="penganjur" value="{{ old('penganjur') }}" autocomplete="off">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select {{ $errors->has('peringkat') ? 'is-invalid' : '' }}" id="peringkat"
                            ...
                            @foreach ($peringkatOptions as $opt)
                                <option value="{{ $opt }}" {{ old('peringkat') == $opt ? 'selected' : '' }}>
                                    {{ $opt }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control {{ $errors->has('pautan') ? 'is-invalid' : '' }}"
                        id="pautan" name="pautan" value="{{ old('pautan') }}" autocomplete="off"
                        placeholder="https://...">
                    ...
                    @endif
                    <small class="text-muted">Contoh: pautan pendaftaran / laman web</small>
                </div>
